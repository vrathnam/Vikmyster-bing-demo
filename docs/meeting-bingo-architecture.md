...
graph TD
    subgraph BROWSER["BROWSER ENVIRONMENT"]
        subgraph REACT["REACT APPLICATION"]
            ...
            UI --> CTX["Context State"]
            GAME --> CTX
            SPEECH --> CTX
            CTX --> LS["localStorage Persistence"]
        end
...
```mermaid
graph LR
    A["Select<br/>Category"] --> B["Shuffle<br/>Words"] --> C["Pick 24<br/>Words"] --> D["Render<br/>Card"]
```
...
```mermaid
graph LR
    A["Audio<br/>Input"] --> B["Speech<br/>API"] --> C["Transcript<br/>Text"] --> D["Word<br/>Detection"]
    D --> E["Match<br/>Found?"] --> F["Fill<br/>Square"] --> G["Update<br/>UI"]
```
...
```mermaid
graph LR
    A["Square<br/>Filled"] --> B["Check<br/>Lines"] --> C["BINGO?<br/>Yes!"] --> D["Celebrate<br/>& Share"]
```
